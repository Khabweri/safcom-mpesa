...
use Safcom\Mpesa\Exceptions\CallbackException;
use Safcom\Mpesa\Utils\MpesaHelper;
...
class Mpesa
{
    ...
    public $shortcode;
    /**
     * The Lipa Na MPesa TransactionType
     *
     * @var int
     */
    ...
    public function __construct()
    {
        ...
        $this->transactiontype = config('mpesa.transactiontype');
    ...
    public function stkpush($phonenumber, $amount, $account_number, $callbackurl = null)
    {
        ...
        $data = [
            ...
            'BusinessShortCode' => $this->shortcode, //Has to be a paybill or a till number 
